export const messages = {
  fr: {
    ...
    detail: {
      ...
      when: "Quand",
      where: "O\u00f9",
      occurrencesTitle: "Dates et lieux",
      ...
      shareLead: "Faites connaître cette fiche autour de vous",
      ...
      openOrganizerWebsite: "Visiter le site",
      openTicketing: "Voir la billetterie",
    ...
    editor: {
      ...
      showArchived: "Afficher les \u00e9v\u00e9nements archiv\u00e9s",
      ...
      cropZoomIn: "Zoomer",
      cropZoomOut: "Dézoomer",
      cropConfirm: "Valider le recadrage",
      imageSaveError: "Impossible d'enregistrer l'image. Merci de réessayer.",
      scheduleEyebrow: "Programmation",
      scheduleTitle: "Date et horaire",
      occurrencesTitle: "Dates et lieux",
      addOccurrence: "Ajouter une autre date",
      removeOccurrence: "Supprimer cette date",
      occurrenceLabel: "Date {index}",
      allDay: "\u00c9v\u00e9nement sur toute la journ\u00e9e",
      locationEyebrow: "Lieu",
      locationTitle: "Lieu et localisation",
      locationLead:
        "Vous pouvez renseigner un lieu pr\u00e9cis, ou seulement la ville si vous ne connaissez pas l'adresse exacte \u2014 l'\u00e9v\u00e9nement sera localis\u00e9 sur la commune. Ajoutez plusieurs dates si l'\u00e9v\u00e9nement se d\u00e9roule \u00e0 plusieurs reprises ou \u00e0 plusieurs endroits.",
      geolocationStatus: "Statut de la localisation",
      geolocationExact: "Position exacte",
      geolocationApproximate: "Position approximative",
      geolocationUnresolved: "Position non trouv\u00e9e",
      geolocationPending: "Position \u00e0 d\u00e9terminer \u00e0 l'enregistrement",
      ...
      optionalContacts: "Coordonnées facultatives",
      noOptionalInfo: "Aucune information renseignée",
      expandSection: "Afficher",
      collapseSection: "Replier",
      dateToComplete: "Date à compléter",
      validationSummary: "Informations à compléter avant de soumettre cette fiche :",
      requiredField: "Ce champ est requis pour soumettre la fiche.",
      postalCodeForCity: "Code postal à renseigner pour choisir une ville",
      ...
      seoAutomatic: "Référencement automatique",
      seoCustomized: "Référencement personnalisé",
      alertCount: "{count} conseil | {count} conseils",
      seoPreviewIndicative: "Aperçu indicatif",
      seoLead:
    ...
    admin: {
      ...
      createAction: "Cr\u00e9er",
      inviteSent: "Un email d'invitation a \u00e9t\u00e9 envoy\u00e9 \u00e0 {email} pour d\u00e9finir son mot de passe.",
  ...
  en: {
    ...
    detail: {
      ...
      when: "When",
      where: "Where",
      occurrencesTitle: "Dates and locations",
      ...
      shareLead: "Help others discover this listing",
      shareNative: "Share",
      copyLink: "Copy link",
      ...
      openOrganizerWebsite: "Visit the website",
      openTicketing: "View ticketing",
    ...
    editor: {
      ...
      archive: "Archive",
      unarchive: "Unarchive",
      showArchived: "Show archived events",
      ...
      imageSaveError: "Unable to save the image. Please try again.",
      scheduleEyebrow: "Schedule",
      scheduleTitle: "Date and time",
      occurrencesTitle: "Dates and locations",
      addOccurrence: "Add another date",
      removeOccurrence: "Remove this date",
      occurrenceLabel: "Date {index}",
      allDay: "All-day event",
      locationEyebrow: "Location",
      locationTitle: "Venue and location",
      locationLead:
        "You can provide a precise venue, or just the city if you don't know the exact address — the event will be located at the town level. Add several dates if the event happens more than once or in more than one place.",
      geolocationStatus: "Location status",
      geolocationExact: "Exact position",
      geolocationApproximate: "Approximate position",
      geolocationUnresolved: "Position not found",
      geolocationPending: "Position to be determined on save",
      ...
      optionalContacts: "Optional contact details",
      noOptionalInfo: "No information entered",
      expandSection: "Show",
      collapseSection: "Collapse",
      dateToComplete: "Date to complete",
      validationSummary: "Complete these details before submitting this event:",
      requiredField: "This field is required to submit the event.",
      postalCodeForCity: "Enter a postal code to select a city",
      ...
      seoAutomatic: "Automatic search preview",
      seoCustomized: "Customized search preview",
      alertCount: "{count} suggestion | {count} suggestions",
      seoPreviewIndicative: "Illustrative preview",
      seoLead:
    ...
    admin: {
      ...
      fullName: "Full name",
      createAction: "Create",
      inviteSent: "An invitation email was sent to {email} to set their password.",
      overview: "Overview",
