<template>
  <section v-if="events.length > 0" class="space-y-5" data-testid="related-events">
    <div class="flex flex-wrap items-end justify-between gap-3">
      <div>
        <p class="text-xs font-semibold uppercase tracking-[0.24em] text-sky-700/70">À découvrir aussi</p>
        <h2 class="font-display mt-2 text-2xl font-semibold tracking-tight text-slate-950">
          D'autres rendez-vous du calendrier
        </h2>
      </div>
      <p class="text-sm text-slate-500">À proximité et autour des mêmes dates</p>
    </div>
      ...
      >
        ...
        <div class="space-y-3 p-5">
          ...
          <div class="border-t border-sky-100 pt-3">
            <span class="text-sm font-semibold text-slate-900">Voir l'événement</span>
          </div>
        </div>
      </li>
    </ul>
